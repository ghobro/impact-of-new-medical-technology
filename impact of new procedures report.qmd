...
6.  We have not found a way to identify primary procedure for a multi-episode spell (where more than one episode has procedure codes). This is largely resolved through the focus on elective admissions, but we may wish to consider non-elective admissions at some point.
7.  The impact of the COVID pandemic has led to us ignoring any data from 2020, which means OPCS-4.9 and OPCS-4.10 have been excluded from the analysis.
